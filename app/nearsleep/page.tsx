...
import { GrowthLink, GrowthView } from "@/components/GrowthAnalytics";

export const metadata: Metadata = {
  title: "NearSleep — A familiar voice for gentler nights",
  description: "Create personalized baby bedtime stories and calming audio in your own familiar voice.",
  alternates: { canonical: "/nearsleep" },
  openGraph: { images: [{ url: "/og.png", width: 1200, height: 630, alt: "NearSleep — Your voice. Their gentlest bedtime." }] },
};
...
export default function Home() {
  return (
    <>
      <GrowthView event={{ event: "landing_view", properties: { product: "nearsleep", landingVariant: "nearsleep-hub" } }} />
      <SiteHeader />
      <main>
        ...
        <div className="container hero-grid">
          <div>
            ...
            <div className="hero-actions">
              <GrowthLink className="btn btn-primary" href="/studio" event={{ event: "creation_started", properties: { product: "nearsleep", landingVariant: "nearsleep-hub" } }}>Create tonight’s story <span aria-hidden="true">→</span></GrowthLink>
