...
export function cloudSqlRoleAssignmentPlan(input:{project:string;instance:string;observedSessionUser:string;operationId:string}){
  ...
  const assignments=[
    ...
    {databaseUser:"nearyou-readiness-kill@nearnight.iam",userType:"CLOUD_IAM_SERVICE_ACCOUNT",databaseRole:"nearyou_rollout_controller"},
    {databaseUser:"nearyou-readiness-decision@nearnight.iam",userType:"CLOUD_IAM_SERVICE_ACCOUNT",databaseRole:"nearyou_private_tester_decision"},
