BEGIN;
DO $$ BEGIN CREATE ROLE nearyou_release_policy_owner NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE ROLE nearyou_release_verifier NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE ROLE nearyou_release_key_manager NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE ROLE nearyou_release_maintenance NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
ALTER ROLE nearyou_release_policy_owner NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE;
ALTER ROLE nearyou_release_verifier NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE;
ALTER ROLE nearyou_release_key_manager NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE;
ALTER ROLE nearyou_release_maintenance NOLOGIN NOINHERIT NOCREATEDB NOCREATEROLE;
