...
--> statement-breakpoint
CREATE TRIGGER `canary_entitlement_audit_immutable_delete` BEFORE DELETE ON `canary_entitlement_audit` BEGIN SELECT RAISE(ABORT,'canary_entitlement_audit_immutable'); END;
