...
test("RevenueCat authorization validates timestamped raw-body signature and rejects stale events", async () => {
  ...
  assert.deepEqual(parseRevenueCatEntitlementEvent({ event: { id: "rc_1", app_id: "app_nearyou", environment: "SANDBOX", product_id: "nearyou_plus_monthly", entitlement_ids: ["nearyou_plus"], app_user_id: "rcusr_0123456789abcdef0123456789abcdef", event_timestamp_ms: 200 } }, { appIds: ["app_nearyou"], productIds: ["nearyou_plus_monthly"], entitlementIds: ["nearyou_plus"], environment: "SANDBOX" }), { id: "rc_1", appUserId: "rcusr_0123456789abcdef0123456789abcdef", occurredAtMs: 200, productId: "nearyou_plus_monthly", entitlementId: "nearyou_plus", environment: "SANDBOX" });
  assert.throws(() => parseRevenueCatEntitlementEvent({ event: { id: "rc_2", app_id: "evil", environment: "SANDBOX", product_id: "nearyou_plus_monthly", entitlement_ids: ["nearyou_plus"], app_user_id: "user@example.com", event_timestamp_ms: 200 } }, { appIds: ["app_nearyou"], productIds: ["nearyou_plus_monthly"], entitlementIds: ["nearyou_plus"], environment: "SANDBOX" }), /allowlist/);
});
