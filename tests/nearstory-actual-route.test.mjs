...
test("NearStory actual route atomically enqueues once and enforces tenant, entitlement, readiness, and provider receipts", () => {
  const hooks = fileURLToPath(new URL("./fixtures/cloudflare-test-hooks.mjs", import.meta.url));
  const runner = fileURLToPath(new URL("./fixtures/nearstory-route-runner.mjs", import.meta.url));
